...
void Analyzer::PlotHistogram(){
	...
	histo1 = new TH1F("Histogram1", "10^{4} events generated by Acceptance-Rejectance method", 75, 0, 0.75); //f(x)max je 0.75
	...
	histo1->GetXaxis()->SetTitle("f(x)"); //postavlja oznaku na x-osi
	histo1->GetYaxis()->SetTitle("Events / 0.01"); //postavlja oznaku na y-osi
